...
public class FinancialStatementEntity {
    ...
    @Column(name = "cost_of_goods_sold", nullable = false)
    ...
    @Column(name = "cash_and_cash_equivalents", nullable = false)
    ...
    @Column(name = "shareholder_equity", nullable = false)
    private String shareholderEquity;

    @Column(name = "operating_cash_flow", nullable = false)
    private String operatingCashFlow;

    @Column(name = "investing_cash_flow", nullable = false)
    private String investingCashFlow;

    @Column(name = "financing_cash_flow", nullable = false)
